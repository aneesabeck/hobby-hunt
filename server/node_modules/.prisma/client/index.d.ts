...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, ClientOptions = {}> = {
    meta: {
      modelProps: "user" | "hobby" | "post" | "comments" | "notification"
  ...
  export interface NotificationDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> {
     ...
     * 
     * // Only select the `if`
     * const notificationWithIfOnly = await prisma.notification.findMany({ select: { if: true } })
     * 
     */
     ...
     * })
     * 
     * // Create many Notifications and only return the `if`
     * const notificationWithIfOnly = await prisma.notification.createManyAndReturn({ 
     *   select: { if: true },
     *   data: [
     *     // ... provide data here
     *   ]
  ...
  interface NotificationFieldRefs {
    readonly if: FieldRef<"Notification", 'Int'>
  ...
  export type NotificationWhereInput = {
    ...
    if?: IntFilter<"Notification"> | number
  ...
  export type NotificationScalarWhereWithAggregatesInput = {
    ...
    if?: IntWithAggregatesFilter<"Notification"> | number
